...
.k-dropdown > :hover,
.k-dropdown .k-state-hover, .k-button:hover, .k-button.k-state-hover, .k-action-buttons .k-button:hover, .k-action-buttons .k-button.k-state-hover, .k-toolbar .k-split-button .k-button:hover,
...
.k-button.k-primary:active, .k-button.k-primary.k-state-active, .k-action-buttons .k-primary:active, .k-action-buttons .k-primary.k-state-active, .k-slider .k-draghandle:active, .k-slider .k-draghandle.k-pressed {
  color: #ffffff;
  background-color: #ff6358;
  border-color: #ff6358; }
...
.k-calendar .k-weekend.k-state-selected, .k-calendar:not(.k-calendar-infinite) .k-content .k-state-selected,
.k-calendar:not(.k-calendar-infinite) .k-content .k-weekend .k-state-selected, .k-event, .k-panelbar > .k-item > .k-link.k-state-selected:not(.k-state-expanded),
...
.k-widget.k-state-invalid > [class*="-wrap"],
.ng-invalid.ng-touched > [class*="-wrap"],
.ng-invalid.ng-dirty > [class*="-wrap"] {
  color: #f31700;
  border-color: rgba(243, 23, 0, 0.5); }
...
.k-calendar {
  ...
  .k-calendar:not(.k-calendar-infinite) .k-weekend {
    background-color: #f9f9f9; }
  .k-calendar:not(.k-calendar-infinite) .k-state-hover {
    background-color: #ededed; }
  .k-calendar:not(.k-calendar-infinite) .k-content .k-state-selected.k-state-hover,
  .k-calendar:not(.k-calendar-infinite) .k-content .k-weekend .k-state-selected.k-state-hover {
    background-color: #ed5c52; }
...
.k-rtl .k-menu-horizontal > .k-item + .k-item {
  margin-right: 0;
  margin-left: 0; }
