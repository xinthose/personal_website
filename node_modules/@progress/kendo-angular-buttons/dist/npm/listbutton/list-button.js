...
var ListButton = /** @class */ (function () {
    ...
    ListButton.prototype.subscribeComponentBlurredEvent = function () {
        ...
        this._zone.runOutsideAngular(function () {
            ...
            _this.tabSubscription = _this.navigationService.tab.pipe(filter_1.filter(function () { return _this._isFocused; })).subscribe(_this.handleTab.bind(_this));
            _this.componentBlurredSubscription = merge_1.merge(_this.documentClick, _this.wrapperBlurred).pipe(filter_1.filter(function () { return _this._isFocused; })).subscribe(function () { return _this._zone.run(function () { return _this.blurWrapper(); }); });
        });
    };
    ListButton.prototype.subscribeNavigationEvents = function () {
        ...
        this.closeSubscription = merge_1.merge(this.navigationService.close, this.navigationService.esc).subscribe(function () { return _this.focusWrapper(); });
    };
