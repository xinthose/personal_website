...
var ListButton = /** @class */ (function () {
    ...
    ListButton.prototype.subscribeComponentBlurredEvent = function () {
        ...
        this._zone.runOutsideAngular(function () {
            ...
            _this.componentBlurredSubscription = merge_1.merge(_this.navigationService.tab, _this.documentClick, _this.wrapperBlurred).pipe(filter_1.filter(function () { return _this._isFocused; })).subscribe(function () { return _this._zone.run(function () { return _this.blurWrapper(); }); });
        });
    };
