...
export declare class DropDownListComponent implements ControlValueAccessor, OnDestroy, OnChanges, OnInit, FilterableDropDownComponentBase {
    ...
    constructor(localization: LocalizationService, popupService: PopupService, selectionService: SelectionService, navigationService: NavigationService, disabledItemsService: DisabledItemsService, _zone: NgZone, renderer: Renderer2, hostElement: ElementRef, cdr: ChangeDetectorRef, touchEnabled: boolean);
    ngOnInit(): void;
    /**
     * @hidden
    ...
    private triggerPopupEvents(open);
    /**
     * @hidden
     */
    ...
    private updateState({dataItem, confirm});
    private clearState();
    private resetSelection(index?);
    private onSelectionChange({dataItem});
    private subscribeEvents();
    private correctNavigationIndex(index);
    private unsubscribeEvents();
    private itemFromEvent(event);
    private currentOrDefault(selectedIndex);
    private firstFocusableIndex(index);
    private handleEnter();
    ...
    protected findDataItem({primitive, valueField, data, value}: {
        primitive: boolean;
        valueField: string;
        data: any[];
        value: any;
