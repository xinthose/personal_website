...
var MultiSelectComponent = /** @class */ (function () {
    ...
    Object.defineProperty(MultiSelectComponent.prototype, "activeDescendant", {
        get: function () {
            ...
            else if (util_1.isPresent(focusedListIndex) && this.isOpen) {
    ...
    MultiSelectComponent.prototype.change = function (event) {
        ...
        if (util_1.isPresent(event.removed)) {
            ...
            var filter_2 = function (item) { return prop_1(item) !== prop_1(dataItem_1); };
    ...
    MultiSelectComponent.prototype.removeGroupTag = function (dataItems) {
        ...
        util_1.selectedIndices(dataItems, data, this.valueField)
            .forEach(function (currentValue) { return _this.selectionService.unselect(currentValue); });
        dataItems
            .filter(function (dataItem) { return !util_1.isPresent(data.find(function (value) { return prop(value) === prop(dataItem); })); })
    ...
    MultiSelectComponent.prototype.removeSingleTag = function (dataItem) {
        ...
        if (util_1.isNumber(index)) {
            ...
            var filter_3 = function (item) { return prop(item) !== prop(dataItem); };
