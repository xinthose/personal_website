...
var ComboBoxComponent = /** @class */ (function () {
    ...
    ComboBoxComponent.prototype.attachStreams = function () {
        ...
        this.subs.add(merge_1.merge(this.navigationService.up, this.navigationService.down, this.navigationService.home, this.navigationService.end).subscribe(function (event) { return _this.navigate(event.index); }));
        ...
        }), map_1.map(function (event) { return event.indices[0]; }))
            .subscribe(function (index) {
            var dataItem = _this.data[index];
            _this.change(dataItem);
        }));
        this.subs.add(this.selectionService.onSelect.pipe(filter_1.filter(function (_) { return _this.isOpen; }), tap_1.tap(function (_) { return _this._filtering = false; }), map_1.map(function (event) { return _this.data[event.indices[0]]; }))
    ...
    ComboBoxComponent.prototype.handleEnter = function () {
        ...
        var focusedItemText = util_1.getter(this.data[focused], this.textField);
