...
var AutoCompleteComponent = /** @class */ (function () {
    ...
    AutoCompleteComponent.prototype.subscribeEvents = function () {
        ...
        this.valueChangeSubscription = this.valueChangeSubject.pipe(filter_1.filter(function (candidate) {
        ...
        this.navigationSubscription = merge_1.merge(this.navigationService.up, this.navigationService.down).subscribe(function (event) { return _this.navigate(event.index); });
