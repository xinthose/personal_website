...
var NgbDatepicker = (function () {
    ...
    NgbDatepicker.prototype.ngOnInit = function () {
        if (this.model === undefined) {
            ...
            this._service.minDate = ngb_date_1.NgbDate.from(this.minDate);
            this._service.maxDate = ngb_date_1.NgbDate.from(this.maxDate);
...
var NgbDatepickerService = (function () {
    ...
    Object.defineProperty(NgbDatepickerService.prototype, "maxDate", {
        set: function (date) {
            if (date == null || this._calendar.isValid(date) && datepicker_tools_1.isChangedDate(this._state.maxDate, date)) {
    ...
    Object.defineProperty(NgbDatepickerService.prototype, "minDate", {
        set: function (date) {
            if (date == null || this._calendar.isValid(date) && datepicker_tools_1.isChangedDate(this._state.minDate, date)) {
