...
``` sql
select (select count(v) from bible.t_kjv where b = 99 and c = 1) as ch1,
(select count(v) from bible.t_kjv where b = 99 and c = 2) as ch2,
(select count(v) from bible.t_kjv where b = 99 and c = 3) as ch3,
(select count(v) from bible.t_kjv where b = 99 and c = 4) as ch4,
(select count(v) from bible.t_kjv where b = 99 and c = 5) as ch5,
(select count(v) from bible.t_kjv where b = 99 and c = 6) as ch6,
(select count(v) from bible.t_kjv where b = 99 and c = 7) as ch7,
(select count(v) from bible.t_kjv where b = 99 and c = 8) as ch8,
(select count(v) from bible.t_kjv where b = 99 and c = 9) as ch9,
(select count(v) from bible.t_kjv where b = 99 and c = 10) as ch10,
(select count(v) from bible.t_kjv where b = 99 and c = 11) as ch11,
(select count(v) from bible.t_kjv where b = 99 and c = 12) as ch12,
(select count(v) from bible.t_kjv where b = 99 and c = 13) as ch13,
(select count(v) from bible.t_kjv where b = 99 and c = 14) as ch14,
(select count(v) from bible.t_kjv where b = 99 and c = 15) as ch15,
(select count(v) from bible.t_kjv where b = 99 and c = 16) as ch16,
(select count(v) from bible.t_kjv where b = 99 and c = 17) as ch17,
(select count(v) from bible.t_kjv where b = 99 and c = 18) as ch18,
(select count(v) from bible.t_kjv where b = 99 and c = 19) as ch19,
(select count(v) from bible.t_kjv where b = 99 and c = 20) as ch20,
(select count(v) from bible.t_kjv where b = 99 and c = 21) as ch21,
(select count(v) from bible.t_kjv where b = 99 and c = 22) as ch22,
(select count(v) from bible.t_kjv where b = 99 and c = 23) as ch23,
(select count(v) from bible.t_kjv where b = 99 and c = 24) as ch24,
(select count(v) from bible.t_kjv where b = 99 and c = 25) as ch25,
(select count(v) from bible.t_kjv where b = 99 and c = 26) as ch26,
(select count(v) from bible.t_kjv where b = 99 and c = 27) as ch27,
(select count(v) from bible.t_kjv where b = 99 and c = 28) as ch28
```
